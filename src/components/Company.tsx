    ...
    <div className="w-full bg-slate-800 rounded-2xl p-6 flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full py-2 flex flex-col gap-4 justify-between">
        <div className="">
          ...
          <div className="text-slate-300 pt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi est neque, fermentum non volutpat efficitur, lobortis vitae ipsum. Mauris eget blandit mauris.</div>
        </div>
