...
export function Testimonial() {
  return (
    <div className="w-96 h-[216px] p-6 flex flex-col gap-2 bg-slate-900 rounded-2xl">
      ...
      <span className="text-slate-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi est neque, fermentum non volutpat efficitur, lobortis vitae ipsum. Mauris eget blandit mauris.</span>
