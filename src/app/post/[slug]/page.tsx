    ...
    <div>
      ...
      <div className='max-w-3xl mx-auto px-4 md:px-0 relative top-[104px]'>
        <div className="flex gap-4 flex-wrap items-center">
          ...
          <p className="text-sm text-white">14 de Agosto de 2023</p>
          <p className="text-sm text-white">Leandro Zaia</p>
          <p className="text-sm text-white">8 min de leitura</p>
        </div>

        <h2 className="text-2xl sm:text-3xl font-bold text-white pt-6">Donec pretium arcu a urna suscipit commodo. Phasellus ac pulvinar massa, id dapibus tortor.</h2>
      
        <div className="w-[768] aspect-square md:aspect-video bg-slate-800 rounded-2xl mt-6" />

        <article className="prose prose-invert prose-base sm:prose-lg md:prose-xl mt-6">
        ...
        <Author />
        <h2 className='text-white text-2xl sm:text-3xl md:text-4xl font-semibold border-b border-amber-500 pb-2 inline-block pt-16'>
